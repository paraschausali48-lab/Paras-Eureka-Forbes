export default {
  ...
  products_eyebrow: 'मुंबई मेट्रोपॉलिटन रीजन (MMR)',
  products_title: 'उत्पाद चयन से लेकर स्थापना तक, अधिकृत यूरेका फोर्ब्स सहायता।',
  products_desc:
    'मुफ़्त पानी TDS जाँच बुक करें, एक्वागार्ड और फोर्ब्स उपकरणों की तुलना करें, और खरीदने से पहले पारस सिंह चावसाली से सीधा मार्गदर्शन प्राप्त करें।',
  intro_badge1: 'मुफ़्त होम डेमो',
  intro_badge2: 'आधिकारिक इंस्टॉलेशन सहायता',
  intro_badge3: 'यहाँ कोई ऑनलाइन भुगतान नहीं',
  intro_btn_wa: 'पारस को WhatsApp करें',
  intro_btn_browse: 'उत्पाद ब्राउज़ करें',
  ...
  contact_desc:
    'पूरे मुंबई मेट्रोपॉलिटन रीजन (MMR) में चयनित उत्पाद बुक करने या घर पर मुफ्त डेमो शेड्यूल करने के लिए सीधे कॉल या व्हाट्सएप करें।',
  contact_name: 'नाम:',
  contact_service_area: 'सेवा क्षेत्र:',
  contact_service_area_value: 'मुंबई मेट्रोपॉलिटन रीजन (MMR)',
  contact_phone: 'फोन:',
  contact_email: 'ईमेल:',
  ...
  footer_text1: '© 2026 पारस सिंह चावसाली - स्वतंत्र अधिकृत प्रतिनिधि',
  footer_text2: 'पूरे MMR में विशेषज्ञ मार्गदर्शन, असली यूरेका फोर्ब्स उत्पाद और विशेष डायरेक्ट सेल्स ऑफर प्रदान करना।',
  footer_legal_link: 'कानूनी और कॉपीराइट जानकारी',
  footer_disclaimer_text:
    'अस्वीकरण: यह वेबसाइट पारस सिंह चावसाली द्वारा व्यक्तिगत रूप से संचालित एक स्वतंत्र लीड-जनरेशन पोर्टल है, जो यूरेका फोर्ब्स के कर्मचारी और प्रत्यक्ष बिक्री प्रतिनिधि हैं। यह यूरेका फोर्ब्स लिमिटेड की आधिकारिक वेबसाइट नहीं है। इस साइट पर प्रदर्शित या संदर्भित सभी उत्पाद नाम, लोगो, ब्रांड, ट्रेडमार्क और चित्र यूरेका फोर्ब्स लिमिटेड की एकमात्र संपत्ति हैं और पूरे मुंबई मेट्रोपॉलिटन रीजन (MMR) में प्रत्यक्ष बिक्री की सुविधा के लिए केवल सूचनात्मक और प्रदर्शन उद्देश्यों के लिए उपयोग किए जाते हैं। यह प्लेटफ़ॉर्म केवल उत्पाद प्रदर्शन और पूछताछ उत्पन्न करने के लिए है। इस वेबसाइट के माध्यम से कोई भुगतान या वित्तीय लेन-देन नहीं किया जाता है। सभी अंतिम खरीद, बिलिंग और इंस्टॉलेशन पूरी तरह से आधिकारिक यूरेका फोर्ब्स चैनलों के माध्यम से निपटाए जाते हैं।',
  header_rep_title: 'Paras Eureka Forbes',
  header_rep_badge: 'स्वतंत्र लीड जनरेशन पोर्टल - अधिकृत बिक्री प्रतिनिधि',

  seo_title: 'Paras Eureka Forbes | अधिकृत बिक्री विशेषज्ञ MMR',
  seo_description:
    'मुंबई मेट्रोपॉलिटन रीजन (MMR) में सेवारत स्वतंत्र अधिकृत यूरेका फोर्ब्स प्रत्यक्ष बिक्री विशेषज्ञ। एक्वागार्ड और वैक्यूम क्लीनर के लिए मुफ्त होम डेमो बुक करें।',
  ...
  faq_q5: 'अगर मैं मुंबई मेट्रोपॉलिटन रीजन (MMR) में रहता हूं तो क्या मुझे वाकई RO प्यूरीफायर की जरूरत है?',
  faq_a5:
  ...
  legal_s1_text:
    'इस वेबसाइट पर प्रदान की गई सामग्री केवल शैक्षिक और स्थानीय बिक्री पूछताछ उद्देश्यों के लिए है। मैं, यूरेका फोर्ब्स के एक कर्मचारी और प्रत्यक्ष विक्रेता के रूप में, पूरे मुंबई मेट्रोपॉलिटन रीजन (MMR) में संभावित ग्राहकों को उत्पादों का सटीक प्रतिनिधित्व करने के लिए आधिकारिक उत्पाद छवियों और विशिष्टताओं का उपयोग करता हूं। कोई कॉपीराइट उल्लंघन का इरादा नहीं है। सभी उत्पाद छवियों, मालिकाना प्रौद्योगिकी नामों और ब्रांड संपत्तियों के बौद्धिक संपदा अधिकार पूरी तरह से यूरेका फोर्ब्स लिमिटेड के पास रहते हैं। यह अपॉइंटमेंट बुकिंग को सुव्यवस्थित करने की एक व्यक्तिगत पहल है और यूरेका फोर्ब्स कॉर्पोरेट प्रबंधन द्वारा आधिकारिक तौर पर समर्थित नहीं है।',
